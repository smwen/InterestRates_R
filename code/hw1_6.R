...
loansDataCor <- cor(loansData[,c(1,2,3,19,22,6,21,23,9,18,11,12,13,20)])
loansDataCor
...
## adding Debt.To.Income.Ratio has bad p value
...
## Debt Ratio instead of inquiries doesn't tell us much, bad p value
...
anova(loansDataLm1, loansDataLm2, loansDataLm3, loansDataLm8)
...
anova(loansDataLm1, loansDataLm2, loansDataLm3, loansDataLm4, loansDataLm9)
confint(loansDataLm9)
### This is probably the best one so far

## try other interactions; no dice
loansDataLm10 <- lm(Interest.Rate ~ FICO.Range.mid + Amount.Requested + as.factor(Loan.Length) + Inquiries.in.the.Last.6.Months + Amount.Requested*as.factor(Loan.Length), data=loansData)
...
anova(loansDataLm1, loansDataLm2, loansDataLm3, loansDataLm4,  loansDataLm10)
confint(loansDataLm10)
### Don't use!
...
anova(loansDataLm1, loansDataLm2, loansDataLm3, loansDataLm4, loansDataLm11)
confint(loansDataLm11)
### This is pretty good too, but the interaction isn't allowed

## log10, no interactions
loansDataLm12 <- lm(Interest.Rate ~ log10(FICO.Range.mid) + log10(Amount.Requested) + as.factor(Loan.Length) + Inquiries.in.the.Last.6.Months, data=loansData)
summary(loansDataLm12)
par(mfrow=c(1,2))
plot(loansData$Interest.Rate, loansDataLm11$residuals, col=as.numeric(loansData$Loan.Purpose), pch=19, cex=0.5)
plot(loansDataLm12$fitted.values, loansDataLm12$residuals, col=as.numeric(loansData$Loan.Purpose), pch=19, cex=0.5)
anova(loansDataLm1, loansDataLm2, loansDataLm3, loansDataLm4, loansDataLm12)
confint(loansDataLm12)
